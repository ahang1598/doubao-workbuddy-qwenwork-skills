...
```text
2x2 grid of Japanese digital advertisement banners。
layout：
...
text labels: 今年こそ、解き放て。；沖縄旅行；3日間の癒やし旅；航空券＋ホテル；39,800円〜；絶景、グルメ、体験 ぜんぶ叶う!。
icons:
count: 3。
...
elements: soft pink gradient background；dynamic water splash effects；pink cosmetic jar labeled 'LUMIÈRE Brightening Gel'。
text labels: 毛穴・くすみ卒業！；透明感あふれる；水光肌へ；新感覚スキンケア；初回限定 78%OFF；1,980円。
badges:
count: 3。
style: gold circular。
...
text labels: とろける旨さ！；黒毛和牛；贅沢ステーキ；期間限定；特別価格；通常価格 8,980円；4,980円。
badges:
count: 1。
style: red circular。
labels: A4 A5等級
...
text labels: スキマ時間で；最短合格！；オンライン資格講座；スマホで完結；効率学習で差がつく！；今だけ！ 受講料 20%OFF。
badges:
count: 1。
style: blue circular。
labels: 受講者数 10万人 突破！。
...
```text
A dynamic anime illustration of a girl with spiky blonde hair tied in a high ponytail with a black bow, striking teal eyes, and a dark purple and black magical uniform with gold trim and diamond gems. She is in an intense crouching superhero landing pose, one hand pressed to the ground and the other raised, casting glowing purple magic circles. She is shattering through a glass barrier, with sharp, jagged glass shards flying outward toward the viewer. Through the broken frame behind her, a stylized silhouette of a gothic city with tall spires against a vibrant purple and orange sunset sky is visible. The artwork features sharp angles, high contrast cel-shading, and vibrant colors.
```
...
```text
3-panel manga page。
风格：anime, highly detailed, cinematic lighting, futuristic corporate。
layout：structure: 1 wide top panel, 2 square bottom panels。
panels：
- position: top。
shot: wide landscape。
