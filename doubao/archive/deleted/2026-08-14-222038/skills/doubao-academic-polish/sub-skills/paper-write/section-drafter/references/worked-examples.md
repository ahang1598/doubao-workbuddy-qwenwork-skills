<!-- Source: HKUSTDial/Supervisor-Skills, handbook/06_Case_Studies. Adapted for doubao-academic-polish. -->

# Filled thinking templates (internal planning only)

> **IMPORTANT**: The tables below are **internal planning artefacts** you
> build silently before writing prose. They are NOT what the user sees.
> When the user asks for the Methods, Results, Discussion, Abstract, or
> any other section, your output is paragraph prose for that section —
> not a filled-in table, not a consistency check report. The templates
> teach you how to align the section with the rest of the paper's logic;
> the alignment work happens in your head.
...
template for a published paper. The filled cells show the level of
planning clarity you should have internally before drafting prose
for any section. Sources are
...
| Contribution 4 | Empirical validation: LEAD matches or beats active-learning baselines across multiple datasets with no extra inference cost, with ablations isolating the uncertainty signal (Section 5) |
