...
> structures** you build silently in your head. They are NOT the format
> of your output to the user. Your actual output is six paragraphs of
> flowing English (or Chinese) prose, with no labels, no markdown headers
> like "Paragraph 1: Background", and no bulleted lists of limitations
> or challenges. Use these examples to understand what a strong logical
> chain looks like before drafting — then realize it as prose.
...
the six-paragraph plan that should sit in your head before drafting.
The plans are faithful to the published papers, with some writing
points paraphrased. Sources are
`handbook/06_Case_Studies/6.1`, `6.2`, and
`6.3`.

The purpose is to show the level of structural clarity you should have
internally before writing prose. The actual published Introductions
