...
# 按 block id 区间精读
lark-cli docs +fetch --api-version v2 --doc Z1Fj...tnAc --scope range --start-block-id blkA --end-block-id blkB --detail with-ids

# URL 带 #share 选区锚点时自动局部读取
lark-cli docs +fetch --api-version v2 --doc 'docURL#share-anchor'
