...
description: 小红书热门笔记搜索工具，支持关键词搜索获取热门内容数据，基于数据评分排序推荐热门笔记，助力创作者发现热门趋势、获取创作灵感。
dependency:
  python: []
  system:
---
...
| 执行角色 | 主理人 / 搜狐川 | 按专家团 SOP 路由，主 Agent 或对应子 Agent 均可 |
...
**Q: 本工具由谁调用、能否在子 Agent 中运行？**
A: 按专家团 SOP，搜索类需求（灵感洞察 / 爆款对标）由搜狐川 redfox-xhs-sou 调度，也可由主理人在主 Agent 执行；流程虽涉及意图理解与词拓展，但可在子 Agent 中运行，路由以需求为准，不再限定仅主 Agent。
