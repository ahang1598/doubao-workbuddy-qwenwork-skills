...
It writes what it learns to `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` — a plain-English document about your team that every other skill reads before doing anything. You edit the document, not a config file.
...
| Skill | Purpose |
|---|---|
| **cold-start-interview** | First-run interview that writes `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` |
...
Your configuration is stored at `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` and survives plugin updates.
...
├── .mcp.json
├── practice-profile.md                    # Your team practice profile — written by cold-start, edited by you
├── README.md
├── agents/
│   ├── renewal-watcher.md
│   ├── deal-debrief.md
