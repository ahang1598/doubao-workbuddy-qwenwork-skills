...
description: >
  ...
  `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`. Flags deviations, assesses risk, generates
...
Read a vendor agreement against the playbook this team actually uses (in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`), find every term that deviates, and tell the lawyer what to do about each one — with specific redline language, not vague "consider revising."
...
**Before reading the contract, read `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`.** If it's missing or still has placeholders, surface this bounce:
...
The playbook in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` is the source of truth. It tells you:
...
Check the "one thing" from `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` first. If present:
...
For each playbook category in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`, find the corresponding contract section and compare.
...
**Playbook says:** [our standard position, quoted from `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`]
...
**If they won't move:** [the fallback from `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`, or "escalate to [person]"
...
| Level | Means |
|---|---|
| 🔴 Critical | Don't sign without fixing. A term on the team's "never accept" list in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`, or a deal-breaker. |
...
Severity is always applied *against `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`*. If a term doesn't map cleanly to a playbook position, ask the user which bucket it belongs in and offer to record the answer in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`.
...
Check the escalation matrix in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` against:
...
**Before proceeding to send redlines to the counterparty:** Read `## Who's using this` in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`. If the Role is Non-lawyer:
...
**Before generating a signature envelope or routing for countersignature:** Read `## Who's using this` in `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md`. If the Role is Non-lawyer:
...
**Full memo (default):** As above. Goes in the [CLM] record or the Drive folder from `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` house-style section.
...
- [ ] `~/.codebuddy/plugins/config/legal-workflows/commercial-legal/practice-profile.md` was loaded and quoted — not generic market positions
