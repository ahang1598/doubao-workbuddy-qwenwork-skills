...
1. Read `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` → outputs folder path, AI policy document, last sweep date.
...
6. Flag any use cases in outputs not yet added to the `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` registry.
7. Present results to the human. Only after acknowledgment, update `Last policy sweep` and `gaps_found` in `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`.

**Direct query mode** (with description argument):
1. Read `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` → current policy commitments, use case registry, actual policy document.
...
→ **AI policy document**. The commitments in `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` are a summary; the actual
...
**Do not update `Last policy sweep` or `gaps_found` automatically.** After the sweep results are presented, wait for the human to acknowledge them ("sweep acknowledged," "results reviewed," or equivalent). Only then update `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`:
...
- Extract: vendor added, data use terms agreed to, any AI-specific provisions
  accepted that differ from standard positions in `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`
...
[Any use cases approved since the last sweep that aren't yet in the `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`
...
[If this use case isn't in the registry: "Add to `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` → Use case registry:"]
```
