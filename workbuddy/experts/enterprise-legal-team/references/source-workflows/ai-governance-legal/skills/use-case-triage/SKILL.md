...
1. Read `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`. Confirm registry is populated — if not, stop and direct to setup.
...
## Read `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` first

Before triaging, always read `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`. The use case registry and red lines there
...
Check the use case registry in `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` for a direct or close match.
...
The APPROVED / CONDITIONAL / NOT APPROVED buckets, the red-line definitions, and the CONDITIONAL required-controls list all come from `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` → `## AI use case triage criteria` and `## Use case registry`. If the playbook doesn't define a criterion the use case turns on, ask the user: "Your playbook doesn't cover [specific question]. What's your default position? I'll add it to `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` so the next triage is consistent."

**Before issuing an APPROVED classification (approving an AI use case for deployment):** Read `## Who's using this` in `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`. If the Role is Non-lawyer:
...
**Governance tier:** [Standard / Elevated / High — per `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md`]
...
> "Add to `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` → Use case registry. This means next time the same request
