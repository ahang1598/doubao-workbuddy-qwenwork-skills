...
| Skill | Purpose |
|---|---|
| **cold-start-interview** | Writes `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` from interview + seed docs |
...
| **policy-starter** | Produces a first-draft AI usage policy sourced from published model policies (clinical supervision body, state bars, ILTA, CLOC, NIST, EU AI Act, peer policies), adapted to your practice profile — draft for attorney review, not a finished policy |
...
Your configuration is stored at `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` and survives plugin updates.
...
- The `## Company profile` section is the first block of `~/.codebuddy/plugins/config/legal-workflows/ai-governance-legal/practice-profile.md` by convention. If
