...
description: >
  ...
  style, personal information rights request process, or matter workspace paths. Use when the user says
...
position, a PIA section, a personal information rights request timeline — without re-running the whole
...
2. **Show the customizable map.** List what's in the profile, grouped, with a
   ...
   - **personal information rights request process** — verification, statutory timelines per regime,
...
4. **Make the change.** Show the current value, ask for the new value, explain
   ...
   - *Sub-processor notice 30 days → 14 days:* "`/review-dpa` will now flag
     ...
     logged."
   - *New personal information rights request exemption in the playbook:* "`/draft-personal-information-rights-request` will surface this
...
- **Flag guardrail degradation.** The `[review]` flag, source attribution
  ...
  statutory personal information rights request timelines are adjusted below the regulatory minimum,
