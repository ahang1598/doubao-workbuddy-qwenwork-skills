...
1. Load `~/.codebuddy/plugins/config/legal-workflows/privacy-legal/practice-profile.md` → privacy policy commitments, regulatory footprint, personal information rights request systems.
...
This skill diffs the new requirement against what you currently do (per `~/.codebuddy/plugins/config/legal-workflows/privacy-legal/practice-profile.md` → Privacy policy commitments + the practices documented in PIAs) and produces a gap list with a remediation plan.
...
- `## personal information rights request process` → systems list — what you actually do operationally
...
- **What's actually new?** Many "new" state privacy laws are 90% applicable privacy law with tweaks. Identify the delta from what you already comply with, not the full text.
...
- **Rights** — what users can ask for (personal information rights request-adjacent)
...
**We currently:** [what the config practice-profile.md / privacy policy / practice shows]
...
3. **What you've already half-done** — if you're 80% there for applicable privacy law, the state law delta may be small
...
>
> - `[settled]` — stable, well-known statutory and regulatory references unlikely to have changed (e.g., applicable privacy law Art. 33, applicable privacy law § 1798.100, FTC Act § 5). Still verify before filing, but lower priority.
...
> Citations in this output were generated by an AI model and have not been verified against a primary source. Before relying on any regulation, statute, guidance, or enforcement action, check it against a legal research tool (research platform, your firm's research platform, or the issuing authority's website) for accuracy and current status. AI-generated citations are sometimes fabricated or misquoted. Source tags on each citation (e.g., `[web search — verify]`) show where it came from; `verify` tags carry higher fabrication risk and should be checked first.
