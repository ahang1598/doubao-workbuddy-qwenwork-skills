...
Your configuration is stored at `~/.codebuddy/plugins/config/legal-workflows/product-legal/practice-profile.md` and survives plugin updates.
...
| Skill | Purpose |
|---|---|
| **cold-start-interview** | Writes ~/.codebuddy/plugins/config/legal-workflows/product-legal/practice-profile.md from interview + past launch reviews |
...
Your practice profile at `~/.codebuddy/plugins/config/legal-workflows/product-legal/practice-profile.md` isn't static — it improves as you use the plugin. Skills tell you when an output used a default you should tune. You can re-run setup, edit the file directly, or tell a skill to record a new position.
...
Your configuration is stored at `~/.codebuddy/plugins/config/legal-workflows/product-legal/practice-profile.md` and survives plugin updates — you only run setup once.
