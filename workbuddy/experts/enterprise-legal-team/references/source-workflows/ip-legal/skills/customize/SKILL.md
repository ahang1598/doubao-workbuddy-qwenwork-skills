...
2. **Show the customizable map.** List what's in the profile, grouped, with a
   ...
   - **Workflow** — matter workspaces (matter IDs, family IDs), case docket or procedural record feed,
     invention intake form
   - **Integrations** — patent case docket or procedural record system / trademark office connectors /
