...
1. Load `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → jurisdictional footprint, handbook location.
...
`~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → jurisdictional footprint, handbook location and format.
