...
Read `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → jurisdictional footprint, escalation table, any existing
expansion notes.
...
Write a new file to `~/.codebuddy/plugins/config/legal-workflows/employment-legal/expansion-[country-slug].yaml` with all open items
...
**Roles:** [list]
**Tracker:** ~/.codebuddy/plugins/config/legal-workflows/employment-legal/expansion-[slug].yaml
