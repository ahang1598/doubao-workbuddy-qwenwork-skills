...
`~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → handbook location, state supplements list, update cadence.
...
For each state supplement in `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md`:
