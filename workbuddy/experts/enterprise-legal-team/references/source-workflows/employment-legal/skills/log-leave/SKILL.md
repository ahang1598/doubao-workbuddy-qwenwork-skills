...
Adds a new leave entry to `~/.codebuddy/plugins/config/legal-workflows/employment-legal/leave-register.yaml` with the minimum
...
1. Read `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → jurisdiction table and Systems section.
...
3. Using the jurisdiction table in `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md`, look up the applicable leave
...
5. Write a new entry to `~/.codebuddy/plugins/config/legal-workflows/employment-legal/leave-register.yaml` using the leave register
