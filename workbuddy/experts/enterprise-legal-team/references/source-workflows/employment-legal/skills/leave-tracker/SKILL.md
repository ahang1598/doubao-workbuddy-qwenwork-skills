...
2. If no HRIS is connected and no `~/.codebuddy/plugins/config/legal-workflows/employment-legal/leave-register.yaml` exists, prompt
...
integration (calendar reminder, cron job, etc.); CodeBuddy agents do not
self-schedule.
