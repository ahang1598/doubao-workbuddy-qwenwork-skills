...
1. Load `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → jurisdictional footprint, hiring review triggers, restrictive covenant policy.
...
`~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → jurisdictional footprint, hiring review triggers, restrictive
covenant policy, offer letter template location.

## Output header

Prepend the work-product header from `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` → `## Outputs` (it differs by user role — see `## Who's using this`).
...
Check the jurisdiction table in `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` for this state/country. If it's
...
Per `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` restrictive covenant policy: does this hire even get one?
...
Check the `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md` table for this jurisdiction. Common categories to
...
**Before producing a "Clear to send" recommendation or a final offer letter for signature:** Read `## Who's using this` in `~/.codebuddy/plugins/config/legal-workflows/employment-legal/practice-profile.md`. If the Role is **Non-lawyer**:
