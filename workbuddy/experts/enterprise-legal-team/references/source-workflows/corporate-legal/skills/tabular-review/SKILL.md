...
1. Load `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/practice-profile.md` → diligence structure, thresholds, house format.
...
- `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/practice-profile.md` → diligence structure, materiality thresholds, house format preferences
- `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/deals/[code]/deal-context.md` if working a specific deal
