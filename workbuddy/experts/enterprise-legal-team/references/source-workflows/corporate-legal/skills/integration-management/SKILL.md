...
5. Read/write `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/deals/[code]/integration-tracker.yaml`.
...
Lives at `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/deals/[code]/integration-tracker.yaml`. Read `deal-context.md` for
...
Read `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/deals/[code]/deal-context.md`. If not found: ask for deal code name,
target company, close date, deal lead, and outside counsel. Write to
deal-context.md if it doesn't exist.

Read `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/deals/[code]/closing-checklist.yaml` if it exists. Any items marked as
...
>   automatically from `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/deals/[code]/closing-checklist.yaml`
...
- IP assignment recordal at IP registry (patents, trademarks) [priority: high]
...
**Manual update:** Attorney tells AI assistant what changed.
...
AI assistant updates the relevant tracker entry, recalculates any downstream status
