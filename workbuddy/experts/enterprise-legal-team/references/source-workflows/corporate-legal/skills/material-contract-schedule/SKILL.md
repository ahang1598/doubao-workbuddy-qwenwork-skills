...
- `~/.codebuddy/plugins/config/legal-workflows/corporate-legal/practice-profile.md` → materiality thresholds (may differ from the agreement definition — use the agreement's)
