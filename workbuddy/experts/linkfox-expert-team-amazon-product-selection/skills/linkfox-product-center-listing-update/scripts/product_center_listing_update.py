#!/usr/bin/env python3
"""商品库-更新Listing - LinkFox Skill
调用 /product-center/v1/skill/product/listing/{listingId}/update 接口。

Usage:
  python product_center_product_create.py '<JSON parameters>'           # 自动:小结果全量;大结果落盘+摘要
"""
...
API_PATH = "/product-center/v1/skill/product/listing/{listingId}/update"
SLUG = "linkfox-product-center-listing-update"
