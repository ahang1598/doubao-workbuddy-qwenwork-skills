#!/usr/bin/env python3
"""商品库-更新变体 - LinkFox Skill
调用 /product-center/v1/skill/product/variant/{skuId}/update 接口。

Usage:
  python product_center_variant_update.py '<JSON parameters>'           # 自动:小结果全量;大结果落盘+摘要
"""
...
API_PATH = "/product-center/v1/skill/product/variant/{skuId}/update"
SLUG = "linkfox-product-center-variant-update"
