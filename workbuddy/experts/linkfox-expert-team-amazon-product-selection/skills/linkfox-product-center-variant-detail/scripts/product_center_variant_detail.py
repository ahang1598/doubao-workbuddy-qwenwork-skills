#!/usr/bin/env python3
"""商品库-变体详情 - LinkFox Skill
调用 /product-center/v1/skill/product/variant/{skuId} 接口。

占位符（被 scaffold_skill.py 或手工替换）：
  商品库-变体详情  中文一句话标题      /product-center/v1/skill/product/variant/{skuId}  网关端点路径
  linkfox-product-center-variant-detail      skill 标识(=目录名)  product_center_variant_detail.py   本脚本文件名

Usage:
  python product_center_variant_detail.py '<JSON parameters>'           # 强制落盘，输出路径+摘要
"""
...
API_PATH = "/product-center/v1/skill/product/variant/{skuId}"
SLUG = "linkfox-product-center-variant-detail"
