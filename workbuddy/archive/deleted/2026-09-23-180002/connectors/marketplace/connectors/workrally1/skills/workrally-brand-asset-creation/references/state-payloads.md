...
Write these complete JSON shapes into the brand job's working directory with a quoted heredoc
(`cat > brandkit/input.json <<'JSON' … JSON`). Replace values only. Keep asset objects, arrays, key
names, and nesting unchanged.
