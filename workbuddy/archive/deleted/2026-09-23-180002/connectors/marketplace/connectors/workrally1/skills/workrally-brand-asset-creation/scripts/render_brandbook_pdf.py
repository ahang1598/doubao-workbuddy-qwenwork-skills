...
`build_brandbook.py` owns the PPTX structure. This script owns only the
operating-system interaction: registering the approved fonts, invoking
LibreOffice, and checking the embedded PDF fonts with Poppler. It requires
`fc-cache`, `fc-match`, `soffice` and `pdffonts` on PATH.
"""
